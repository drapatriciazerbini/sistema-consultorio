...
alter table public.clinic_settings
  add column if not exists template_d15 text not null default
    'Olá! Aqui é da equipe do Dr. Marcello Ruiz, gastroenterologista pediátrico. Já se passaram 15 dias da consulta de {nome}. Como {pronome} está se adaptando às orientações? Se surgiu qualquer dúvida, é só responder por aqui. 💙';
