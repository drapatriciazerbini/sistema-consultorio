    ...
    <section className="surface-card overflow-hidden rounded-[26px]">
      <div className="border-b border-[#193d36]/[0.06] bg-gradient-to-r from-white to-[#f9f8f3] p-5 sm:p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h2 className="mt-1 text-base font-extrabold tracking-[-0.03em] text-[#193d36]">Respostas prontas</h2>
      ...
      <div className="space-y-4 p-5 sm:p-6">
        ...
        {carregando ? (
          ...
          <p className="rounded-[16px] bg-[#f8f6f0] px-4 py-6 text-center text-[11px] text-slate-400">
            Nenhum assunto cadastrado. O robô continua oferecendo o menu.
          </p>
        ) : (
          visiveis.map(({ item, indice }) => (
            <div key={item.id || `nova-${indice}`} className="rounded-[22px] border border-[#193d36]/[0.07] bg-white p-4 sm:p-5">
              <div className="flex flex-wrap items-end justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-[13px] border border-[#193d36]/10 p-2.5 text-slate-400 transition hover:border-red-200 hover:text-red-500"
                  >
              ...
              {/* Para o que muda de unidade para unidade - o valor, sobretudo.
                  ...
                  acima vira reserva. */}
              <label className="mt-3 flex cursor-pointer items-start gap-2.5 rounded-[14px] border border-[#193d36]/[0.06] bg-[#f8f6f0] px-3.5 py-3">
                <input
                  type="checkbox"
                  checked={item.perguntarUnidade}
                  onChange={(e) => mudar(indice, { perguntarUnidade: e.target.checked })}
                  className="mt-0.5 h-3.5 w-3.5 accent-[#2f7f74]"
                />
